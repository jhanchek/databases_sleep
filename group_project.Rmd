...
```
This is our model for Rating.Average. It outputs the function "Rating.Average = (-0.216 * (Year.Published)) + (-71.760 (Min.Players)) + (2.06 (Max.Players)) + (-0.170 (Play.Time)) + (85.487 (Min.Age)) + (424.054 (Complexity.Average)) = 
```{r}
...
```
This is our model for Owned.Users.
```{r}
